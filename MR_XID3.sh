...
pkg install figlet python2
pip2 install lolcat
git clone https://github.com/TUANB4DUT/REVERSEIP
cd REVERSEIP
chmod 777 REVERSEIP.sh
./REVERSEIP.sh
fi 
...
pkg install figlet python2
pip2 install lolcat
git clone https://github.com/TUANB4DUT/TRACKIP
cd TRACKIP
chmod 777 TRACKIP.sh
./TRACKIP.sh
fi
...
pkg install figlet python2
pip2 install lolcat
git clone https://github.com/TUANB4DUT/DNSLOOKUP
cd DNSLOOKUP
chmod 777 DNSLOOKUP.sh
./DNSLOOKUP.sh
fi 
...
echo -x "${y} ls"
echo -x "${y} Nah kalian tinggal masuk ke dictiory virusnya"
...
echo "\033[32;1mauthor: MR_XID"
echo "\033[33;1mTeam: JATIM BLACKHAT"
...
echo "[==========SELAMAT ANDA MENJADI DEFACEE :V==========]"
fi
